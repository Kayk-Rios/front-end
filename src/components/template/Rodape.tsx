        ...
        <div className="container flex flex-col py-10 gap-10">
          <div className="flex flex-col md:flex-row items-center md:items-start justify-between text-center md:text-left gap-5 md:gap-0">
            ...
            <div className="flex flex-col gap-1">
              ...
              <span className="text-sm">menosum48@gmail.com</span>
              <div className=" text-sm flex items-center gap-2 justify-center md:justify-start"></div>
            </div>
          </div>
          <div className="flex flex-col md:flex-row items-center md:items-start justify-between text-center md:text-left gap-5 md:gap-0">
            <div className="flex gap-2 ">
              Icone instagram icone wharsap Icone linkedin
            </div>
